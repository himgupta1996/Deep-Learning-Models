# -*- coding: utf-8 -*-
"""
Created on Sat Mar 30 21:12:44 2019
...
for lr in learning_rates:
    ...
    axes[0].plot(np.arange(1,epoch+1),Accuracy_validation,label="lr=%s"%(lr))
    axes[1].plot(np.arange(1,epoch+1),Accuracy_training,label="lr=%s"%(lr))
...
fig.savefig('Experiment_cnn_learning_rate_final.jpg')
plot_index+=1
